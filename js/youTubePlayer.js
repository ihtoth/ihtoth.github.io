function onYouTubeIframeAPIReady() {
  ...
  var playerThree;
  playerThree = new YT.Player('muteYouTubeVideoPlayerPinDrop', {
    videoId: 'oa8YTs_5REI', // YouTube Video ID
    width: 724,               // Player width (in px)
    height: 487,              // Player height (in px)
    playerVars: {
      autoplay: 0,        // Auto-play the video on load
  ...
  var playerFour;
  playerFour = new YT.Player('muteYouTubeVideoPlayerCompanySearch', {
    videoId: 'xMBexbMU7rs', // YouTube Video ID
    width: 724,               // Player width (in px)
    height: 487,              // Player height (in px)
    playerVars: {
      autoplay: 0,        // Auto-play the video on load
